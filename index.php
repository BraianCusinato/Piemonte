...
?>
		...
		<div>
			...
			<ul>
				...
				<li><b>Ticino</b>, lungo 248 km, il secondo fiume italiano per portata d’acqua, immissario ed emissario del <a href="lago-maggiore.php">Lago<br> Maggiore</a>, scorre però solo per pochi km interamente in Piemonte in quanto funge da confine con la<br> Lombardia;</li>
			</ul>
		</div>
		<h2>Le attività</h2>
		<div>
